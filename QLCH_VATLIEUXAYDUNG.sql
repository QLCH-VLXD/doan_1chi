...
(
	...
	TENLOAIKH NVARCHAR(50),		--(KH THÂN THIẾT, VIP, THƯỜNG)
...
(
	MALOAIMATHANG NVARCHAR(10) NOT NULL,
	TENLOAIMATHANG NVARCHAR(50),		--(GẠCH, CÁT, KÍNH, XI MĂNG, NGÓI, SƠN, KEO, TÔN,.....)
...
(
	...
	TENDVT NVARCHAR(50),		--(KHỐI, MÉT, BAO, THÙNG, KG,.....)
	PRIMARY KEY (MADVT)
);
...
(
	MACHITIETMATHANG NVARCHAR(10) NOT NULL,
	MAMATHANG NVARCHAR(10),
	MAPN NVARCHAR(10),
	NGAYSANXUAT DATE,
	NGAYHETHAN DATE,
...
ADD  SOTIENCONLAI MONEY


CREATE TABLE CTPHIEUDATHANGNSX
(
	MACTPHIEUDATHANG NVARCHAR(10) NOT NULL,
	MAPDHNSX NVARCHAR(10),
	MAMATHANG NVARCHAR(10),
	SOLUONG INT,
	GIA MONEY,
	THANHTIEN MONEY,
...
(
	MACTPN NVARCHAR(10) NOT NULL,
	MAPN NVARCHAR(10),
	--(là khóa ngoại,có thể nhập hàng nhiều lần)
	MACTPHIEUDATHANG NVARCHAR(10),
	SOLUONGMH INT,
...
(
	MAGIAOHANG NVARCHAR(10)  NOT NULL,

	MANVGIAOHANG NVARCHAR(10),
...
(
	MACTGIAOHNAG NVARCHAR(10)  NOT NULL,
	MAGIAOHANG NVARCHAR(10),
	MACTHDB NVARCHAR(10),
	SOLUONGMH INT,
	THANHTIEN MONEY,
...
alter FUNCTION XEM_TENKH(@MKH NVARCHAR(10))
RETURNS NVARCHAR(50)
AS
	BEGIN
...
VALUES	('NSX01','090763267',N'ctythepquocviet@gmail.com',N'Công ty TNHH Sản xuất thương mại và dịch vụ thép Quốc Việt',N'52 Tây Thạnh, Phường 15, Tân Phú, Hồ Chí Minh'),
		('NSX02','080543267',N'ctyhtb@gmail.com',N'Công Ty TNHH Thương Mại Sản Xuất Tân Hoàng Thiên Bảo',N'12 Bình Giã, Phường 13, Tân Bình, Hồ Chí Minh'),
		('NSX03','080547267',N'ctyFico@gmail.com',N'Tổng Công Ty Vật Liệu Xây Dựng Số 1 - FiCO',N'Sailing Tower, 111 A Pasteur, Bến Nghé, Quận 1, Bến Nghé Quận 1 Thành phố Hồ Chí Minh'),
		('NSX04','036832267',N'ctytrungthanhloi@gmail.com',N'Công Ty TNHH Sản Xuất Thương Mại Dịch Vụ Xây Dựng Trung Thành Lợi',N'309, Tân Kỳ Tân Quý, Phường Tân Sơn Nhì, Quận Tân Phú, Thành Phố Hồ Chí Minh')
...
VALUES	('CTHDB01','HD01','MH01','300','3200000'),
		('CTHDB02','HD02','MH02','400','57000000'),
		('CTHDB03','HD03','MH03','130','22400000'),
		('CTHDB04','HD04','MH04','170','1300000')
